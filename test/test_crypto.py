...
class TestCrypto(unittest.TestCase):
    ...
    def test_sign_import_small_file(self):
        """
        Test that we can sign a small imported file
        """
        key = generate_keys()
        ...
        self.assertTrue(key.verify(file_to_sign, signature))

    def test_sign_import_big_file(self):
        """
        Test the signature of a big imported file 
        """
        key = generate_keys()
        with open("ex2_file_to_sign", "w") as file_:
